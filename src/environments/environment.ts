...
import {
  Ability
} from "../app/models/ability";
import {
  Wargear
} from "../app/models/wargear";
import {
  Weapon
} from "../app/models/weapon";
...
export const abilities = {
  ...
  blast: new Ability({
    name: 'Blast',
    rules: ['If target unit has 6+ models, this has at least 3 attacks. <br/>If target unit has 11+ models, this has 6 attacks.']
  }),
